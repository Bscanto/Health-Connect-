						...
						<ul class="sidebar-menu">
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									...
									<li><a href="index.php?pagina=profissionais"><i class="fa fa-angle-right"></i>Pacientes</a></li>
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									<li><a href="index.php?pagina=usuarios"><i class="fa fa-angle-right"></i> Relatórios</a></li>
								</ul>
							</li>
