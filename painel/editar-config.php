...
$query = $pdo->prepare("UPDATE $tabela SET nome = :nome, email = :email, telefone = :telefone, endereco = :endereco, instagram = :instagram, marca_dagua = :marca_dagua, meta_diaria = :meta_diaria, meta_mensal = :meta_mensal, meta_anual = :meta_anual where id = 1");
...
$query->bindValue(":meta_diaria", "$meta_diaria");
$query->bindValue(":meta_mensal", "$meta_mensal");
$query->bindValue(":meta_anual", "$meta_anual");
$query->execute();
