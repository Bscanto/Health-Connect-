...
<td>
	<big><a href="#" onclick="editar('{$id}', '{$nome}', '{$email}', '{$senha}', '{$senha_crip}', '{$nivel}', '{$ativo}', '{$telefone}', '{$endereco}', '{$foto}', '{$data}', '{$token}', '{$estado}', '{$cidade}', '{$bairro}', '{$cep}', '{$numero}', '{$data_nasc}', '{$sexo}', '{$cpf}', '{$cbo}', '{$cnsp}')" title="Editar Dados"><i class="fa fa-edit text-primary"></i></a></big>
...
<script type="text/javascript">
	function editar(id, nome, email, senha, senha_crip, nivel, ativo, telefone, endereco, foto, data, token, estado, cidade, bairro, cep, numero, data_nasc, sexo, cpf, cbo, cnsp) {
		$('#mensagem').text('');
